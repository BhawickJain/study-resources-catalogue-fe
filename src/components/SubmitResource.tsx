...
import { BASE_URL, IAppState, IResource } from "../utils/interfaces";
  ...
  */
  ...
  async function handleSubmitResource() {
    ...
    const response = await axios.post(
      `${BASE_URL}/resources`, //change to heroku
      data
    );
    ...
    const contentTypeResponse = await axios.post(
      `${BASE_URL}/tablename/content_types_resource`,
      {
    ...
    const tagDataResponse = await axios.post(
      `${BASE_URL}/tablename/tag_resource`,
      {
    ...
    const weekData = await axios.post(
      `${BASE_URL}/tablename/buildweek_resource`,
      {
